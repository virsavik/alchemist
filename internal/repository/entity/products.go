...
var ProductWhere = struct {
	...
	Sku:       whereHelperstring{field: "\"products\".\"sku\""},
...
var (
	productAllColumns            = []string{"id", "sku", "name", "created_at", "updated_at", "deleted_at"}
	productColumnsWithoutDefault = []string{"id", "sku", "name"}
	productColumnsWithDefault    = []string{"created_at", "updated_at", "deleted_at"}
...
// NewProductQuery is a function to create entity object
func NewProductQuery(mods ...qm.QueryMod) ProductQuery {
	q := Products(mods...)
	return ProductQuery{q}
}

func (p ProductQuery) All(ctx context.Context, exec boil.ContextExecutor) ([]*Product, error) {
	slice, err := p.productQuery.All(ctx, exec)
	if err != nil {
		return nil, err
	}
...
func (p ProductQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Product, error) {
	return p.productQuery.One(ctx, exec)
}
